...
word2descr = {
    ...
    "sunny": "(of weather) Featuring a lot of sunshine.",
    "passing_clouds": "Passing to clouds.",
    "sprinkles_passing_clouds": "Sprinkles passing to clouds.",
    "light_rain_passing_clouds": "Light rain passing to clouds.",
    "light_rain_fog": "Light rain with fog.",
    "fog": "A thick cloud that forms near the ground; the obscurity of such a cloud.",
    "light_rain_mostly_cloudy": "Light rain with mostly cloudy.",
    "rain_mostly_cloudy": "Rain with mostly cloudy.",
    "light_rain_more_clouds_than_sun": "Light rain with more cloudy than sun.",
    ...
    "rain_passing_clouds": "Rain passing to clouds.",
    "scattered_clouds": "Scattered clouds.",
    "fair": "Not overcast, cloudless, clear.",
