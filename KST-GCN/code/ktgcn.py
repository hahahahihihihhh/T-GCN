...
class ktgcnCell(RNNCell):
    """Knowledge Temporal Graph Convolutional Network """

    def call(self, inputs, **kwargs):
        pass

    def __init__(self, num_units, adj, num_nodes, time_len, dim, input_size=None,
                 act=tf.nn.tanh, reuse=None):

        super(ktgcnCell, self).__init__(_reuse=reuse)
        self._act = act
